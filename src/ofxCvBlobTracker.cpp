...
/*
void ofxCvBlobTracker::setListener( ofCvBlobListener* _listener ) {
    listener = _listener;
}
*/
...
void ofxCvBlobTracker::doBlobOn( const ofxCvTrackedBlob& b ) {
    if( listener != NULL ) {
        listener->blobOn( (int)b.center.x, (int)b.center.y, b.id, findOrder(b.id) );
    } else {
...
void ofxCvBlobTracker::doBlobMoved( const ofxCvTrackedBlob& b ) {
    if( listener != NULL ) {
        listener->blobMoved( (int)b.center.x, (int)b.center.y, b.id, findOrder(b.id) );
    } else {
...
void ofxCvBlobTracker::doBlobOff( const ofxCvTrackedBlob& b ) {
    if( listener != NULL ) {
        listener->blobOff( (int)b.center.x, (int)b.center.y, b.id, findOrder(b.id) );
    } else {
